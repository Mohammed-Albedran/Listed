...
var welcomeDiv = document.querySelector(".welcome");
 function addDarkMode(){
     ...
     welcomeDiv.classList.add("welcomeDark");
...
var noteColor5 = document.querySelectorAll(".noteColor5");
 function removeDarkMode(){
    ...
    welcomeDiv.classList.remove("welcomeDark");
...
function addArabicLang(){
    ...
    var welcomeDiv1 = document.querySelector(".welcome");

    tasks.classList.add("tasksAr");
    welcomeDiv1.classList.add("welcomeAr");
    ...
    //welcome div//
    welcomeDiv1.getElementsByTagName("h2")[0].innerHTML = "مرحبًا بك في <bdi>Listed</bdi> ، هنا يمكنك إدارة مهامك بسهولة وبخصوصية تامة ، ابدأ بإضافة مهمتك الأولى";
    welcomeDiv1.querySelector(".create").innerHTML = "اضافة مهمة";
    welcomeDiv1.querySelector(".later").innerHTML = "لاحقا";
    //select//
...
function removeArabicLang(){
    ...
    welcomeDiv1.classList.remove("welcomeAr");
    ...
    //welcome div//
    welcomeDiv1.getElementsByTagName("h2")[0].innerHTML = "Welcome to Listed, here you can manage your tasks easly and in complete privacy,start by making your first task";
    welcomeDiv1.querySelector(".create").innerHTML = "Create a task";
    welcomeDiv1.querySelector(".later").innerHTML = "Later";
    //select//
    var allS = document.querySelector(".allS");
    var checkS = document.querySelector(".checkS");
    var uncheckS = document.querySelector(".uncheckS");
...
function welcomeMessage(){
    var welcomeDiv = document.querySelector(".opacityDiv");
...
function controlWelcome(statues){
    var welcomeDiv = document.querySelector(".opacityDiv");
    if(statues == "create"){
        welcomeDiv.style.display = "none";
        localStorage.setItem("welcome","true");
        openAddNewTask("openDiv");
    }else if(statues == "later"){
        welcomeDiv.style.display = "none";
        localStorage.setItem("welcome","true");
    }
}
